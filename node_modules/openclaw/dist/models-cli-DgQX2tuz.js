...
import { n as validateAnthropicSetupToken } from "./auth-token-BAAA20NY.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureOpenClawModelsJson } = await import("./reply-BEN3KNDZ.js").then((n) => n.bf);
