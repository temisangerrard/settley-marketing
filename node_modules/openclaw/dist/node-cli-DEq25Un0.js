...
import { Ji as startBrowserControlServiceFromConfig, Kc as analyzeArgvCommand, Ki as createBrowserRouteDispatcher, Ll as VERSION, Ws as loadConfig, Xc as resolvePlannedSegmentArgv, dl as unwrapKnownDispatchWrapperInvocation, fl as unwrapKnownShellMultiplexerInvocation, hl as resolveInlineCommandMatch, ki as writeJsonAtomic, ll as normalizeExecutableToken, nl as resolveExecutableFromPathEnv, pl as POSIX_INLINE_COMMAND_FLAGS, qi as createBrowserControlContext, rl as POSIX_SHELL_WRAPPERS, tl as resolveCommandResolutionFromArgv, ua as resolveBrowserConfig, vi as GATEWAY_CLIENT_MODES, yi as GATEWAY_CLIENT_NAMES } from "./model-selection-CGLtPxol.js";
import { i as resolveAgentConfig } from "./agent-scope-C2X-qS_p.js";
import { s as sameFileIdentity } from "./openclaw-root-DrFjwUcG.js";
import { i as logWarn } from "./logger-BefOyj1a.js";
...
import { S as sanitizeSystemRunEnvOverrides, x as sanitizeHostExecEnv } from "./env-overrides-C3AZbPOQ.js";
import "./registry-BbjmejWa.js";
import "./skills-BF57gfzE.js";
import "./frontmatter-7FVJq8_7.js";
import "./plugins-DVtlo8xi.js";
import { r as detectMime } from "./windows-spawn-C0ShDpd1.js";
...
import { dn as loadOrCreateDeviceIdentity, g as GatewayClient } from "./call-CehRyaj4.js";
import { n as getMachineDisplayName, t as withTimeout } from "./with-timeout-CNvn5w8Y.js";
import { n as evaluateShellAllowlist, r as resolveAllowAlwaysPatterns, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-B52wcteL.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-BPVGQm2v.js";
import { _ as saveExecApprovals, c as normalizeExecApprovals, f as readExecApprovalsSnapshot, h as resolveExecApprovals, m as requiresExecApproval, n as addAllowlistEntry, o as mergeExecApprovalsSocketDefaults, p as recordAllowlistUse, r as ensureExecApprovals, v as requestJsonlSocket } from "./exec-approvals-JZbv-hP7.js";
import { n as resolveSystemRunCommandRequest, o as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-CAW0n0MH.js";
import { _ as resolveNodeSystemdServiceName, g as resolveNodeLaunchAgentLabel, l as formatNodeServiceDescription, v as resolveNodeWindowsTaskName } from "./arg-split-djBs3PwT.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-DaGn_nF6.js";
...
import { l as buildNodeServiceEnvironment, n as resolveDaemonInstallRuntimeInputs, p as resolveNodeProgramArguments, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-DFkAu5UR.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DM4uTR2W.js";
import "./systemd-Db30ml4e.js";
import "./service-DhSHZUzS.js";
import { a as createCliStatusTextStyles, f as resolveRuntimeStatusColor, g as installDaemonServiceAndEmit, h as createDaemonActionContext, i as runServiceUninstall, m as buildDaemonServiceSnapshot, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-Cqz_tXbn.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-DElO0IJw.js";
import { t as parsePort } from "./parse-port-gb5YSVRO.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-Bv8dosQO.js";
