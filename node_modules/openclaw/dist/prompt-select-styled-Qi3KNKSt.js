...
import { Ac as ensureAuthProfileStore, Ai as hasAmbiguousGatewayAuthModeConfig, Ba as DEFAULT_SANDBOX_IMAGE, Di as resolveConfiguredSecretInputWithFallback, Fi as resolveGatewayAuth, Ka as resolveBootstrapTotalMaxChars, Lo as writeConfigFile, Mo as readConfigFileSnapshot, Ot as loadSessionStore, Pc as updateAuthProfileStoreWithLock, Qi as isLoopbackHost, Ra as DEFAULT_SANDBOX_BROWSER_IMAGE, Sc as repairOAuthProfileIdMismatch, Tn as resolveMainSessionKey, Ui as readGatewayTokenEnv, Un as formatSessionArchiveTimestamp, Ur as inspectPortUsage, Wa as resolveBootstrapMaxChars, Wc as getModelRefStatus, Wn as isPrimarySessionTranscriptFileName, Xa as resolveApiKeyForProfile, _u as DEFAULT_PROVIDER, aa as resolveGatewayBindHost, bu as CODEX_CLI_PROFILE_ID, el as resolveConfiguredModelRef, gu as DEFAULT_MODEL, hl as resolveApiKeyForProvider, l as resolveProfileUnusableUntilForDisplay, nl as resolveHooksGmailModel, pr as cleanStaleLockFiles, qr as formatPortDiagnostics, xa as resolveSandboxScope, yu as CLAUDE_CLI_PROFILE_ID } from "./auth-profiles-MKCH-k1W.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { _ as DEFAULT_AGENTS_FILENAME, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId } from "./agent-scope-Cwa3GjIC.js";
import { E as parseAgentSessionKey } from "./session-key-GuEQvqMH.js";
import { S as sleep, v as resolveUserPath, x as shortenHomePath } from "./utils-0k7pUAq8.js";
...
import { n as listChannelPlugins } from "./plugins-BgwnwmkA.js";
import { Gt as buildAuthHealthSummary, Kt as formatRemainingShort, Tr as resolveAgentSessionDirs, Wt as DEFAULT_OAUTH_WARN_MS, br as buildBootstrapInjectionStats, jr as resolveBootstrapContextForRun, l as loadOpenClawPlugins, yr as analyzeBootstrapBudget } from "./compact-1mmJ_KWL.js";
import { c as resolveStorePath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-a7Rsgqtt.js";
import { C as resolveCronStorePath, S as loadCronStore, w as saveCronStore } from "./send-BBhcyCkK.js";
import { n as loadModelCatalog } from "./model-catalog-DpydombN.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-rN1k4f-b.js";
import { u as resolveDmAllowState } from "./pi-tools.policy-Bq4sMN0R.js";
import { g as resolveNodeLaunchAgentLabel, m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName, u as resolveGatewayLaunchAgentLabel } from "./arg-split-AFn4-5NG.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-CgCXGdzV.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-Brn1u_2n.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-DoUbK5fH.js";
import { r as resolveMemoryBackendConfig } from "./search-manager-YVuEXd-D.js";
import { a as resolveMemorySearchConfig, i as hasConfiguredMemorySecretInput } from "./manager-mlu25MUh.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-20tRo9Jk.js";
import { t as note$1 } from "./note-D_-wdXWA.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-ByBXLFLS.js";
import { a as renderSystemNodeWarning, o as resolveSystemNodeInfo } from "./daemon-install-plan.shared-DdGjoRZK.js";
...
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-BSvRTNYU.js";
import { i as isSystemdUserServiceAvailable, u as uninstallLegacySystemdUnits } from "./systemd-CcwWmJAp.js";
import { a as isLaunchAgentLoaded, i as isLaunchAgentListed, n as resolveGatewayService, o as launchAgentPlistExists, s as repairLaunchAgentBootstrap, t as describeGatewayServiceRestart } from "./service-B9XdMNnP.js";
import { c as buildPlatformRuntimeLogHints, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as readEmbeddedGatewayToken, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-CCGfNoXz.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-DLNV1ovA.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-D3cfyAcI.js";
import { r as healthCommand } from "./health-BxAgqqNt.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-bcmHPAUF.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-Cdd6cUnK.js";
import { t as runGatewayUpdate, u as normalizeStoredCronJobs } from "./update-runner-CsfK3SMx.js";
import { n as logConfigUpdated } from "./logging-D9cwAGmq.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./oauth-tls-preflight-BGauyjft.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-DtFmgkAz.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CVhkc4zb.js";
import { t as formatHealthCheckFailure } from "./health-format-BDFF4fTs.js";
import { n as doctorShellCompletion } from "./doctor-completion-B1RDuSFU.js";
