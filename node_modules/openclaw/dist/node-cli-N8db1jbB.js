...
import { Bs as POSIX_SHELL_WRAPPERS, Fr as createBrowserControlContext, Ir as startBrowserControlServiceFromConfig, Js as unwrapKnownDispatchWrapperInvocation, Ks as normalizeExecutableToken, Ns as resolvePlannedSegmentArgv, Oo as loadConfig, Pr as createBrowserRouteDispatcher, Qs as resolveInlineCommandMatch, Rs as resolveCommandResolutionFromArgv, Xs as POSIX_INLINE_COMMAND_FLAGS, Yr as resolveBrowserConfig, Ys as unwrapKnownShellMultiplexerInvocation, _r as writeJsonAtomic, ks as analyzeArgvCommand, or as GATEWAY_CLIENT_MODES, sr as GATEWAY_CLIENT_NAMES, zs as resolveExecutableFromPathEnv } from "./auth-profiles-MKCH-k1W.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { i as resolveAgentConfig } from "./agent-scope-Cwa3GjIC.js";
...
import { S as sanitizeSystemRunEnvOverrides, x as sanitizeHostExecEnv } from "./env-overrides-D6SjLb4J.js";
...
import { r as detectMime } from "./windows-spawn-oQqooioe.js";
...
import { n as getMachineDisplayName, t as withTimeout } from "./with-timeout-BCVMjnwr.js";
import { n as evaluateShellAllowlist, r as resolveAllowAlwaysPatterns, t as evaluateExecAllowlist } from "./exec-approvals-allowlist-BgPONmvb.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-kbuxCUY1.js";
import { dn as loadOrCreateDeviceIdentity, g as GatewayClient } from "./call-rN1k4f-b.js";
import { _ as saveExecApprovals, c as normalizeExecApprovals, f as readExecApprovalsSnapshot, h as resolveExecApprovals, m as requiresExecApproval, n as addAllowlistEntry, o as mergeExecApprovalsSocketDefaults, p as recordAllowlistUse, r as ensureExecApprovals, v as requestJsonlSocket } from "./exec-approvals-Bukn_2nB.js";
import { n as resolveSystemRunCommandRequest, o as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-CK9XrWCE.js";
import { _ as resolveNodeSystemdServiceName, g as resolveNodeLaunchAgentLabel, l as formatNodeServiceDescription, v as resolveNodeWindowsTaskName } from "./arg-split-AFn4-5NG.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-Bm2DtMF6.js";
...
import { l as buildNodeServiceEnvironment, n as resolveDaemonInstallRuntimeInputs, p as resolveNodeProgramArguments, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-DdGjoRZK.js";
import "./runtime-guard-Deu-vbXy.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-BSvRTNYU.js";
import "./systemd-CcwWmJAp.js";
import "./service-B9XdMNnP.js";
import { a as createCliStatusTextStyles, f as resolveRuntimeStatusColor, g as installDaemonServiceAndEmit, h as createDaemonActionContext, i as runServiceUninstall, m as buildDaemonServiceSnapshot, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-XTqnJ4EA.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-CCGfNoXz.js";
import { t as parsePort } from "./parse-port-D7sJcuOK.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-CLLsuBPk.js";
