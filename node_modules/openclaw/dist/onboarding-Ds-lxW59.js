...
import { Gg as writeConfigFile, Vg as readConfigFileSnapshot } from "./auth-profiles-iXW75sRj.js";
...
async function runOnboardingWizard(opts, runtime = defaultRuntime, prompter) {
	const onboardHelpers = await import("./auth-profiles-iXW75sRj.js").then((n) => n.St);
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = await import("./onboard-remote-BaPV2mCE.js").then((n) => n.t);
		const { logConfigUpdated } = await import("./logging-DCdnbtcc.js").then((n) => n.r);
	...
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-Lr9ta1nh.js");
	const { promptAuthChoiceGrouped } = await import("./auth-choice-prompt-DRxRWiVu.js").then((n) => n.t);
	const { promptCustomApiConfig } = await import("./onboard-custom-3nnya9o_.js").then((n) => n.r);
	const { applyAuthChoice, resolvePreferredProviderForAuthChoice, warnIfModelConfigLooksOff } = await import("./auth-choice-CKXB_IhJ.js").then((n) => n.t);
	const { applyPrimaryModel, promptDefaultModel } = await import("./model-picker-DwMR_k6L.js").then((n) => n.i);
	...
	const { configureGatewayForOnboarding } = await import("./onboarding.gateway-config-3Ssi_l1t.js");
	...
	if (opts.skipChannels ?? opts.skipProviders) await prompter.note("Skipping channel setup.", "Channels");
		...
		const { setupChannels } = await import("./onboard-channels-DnSKFxsv.js").then((n) => n.n);
	...
	if (opts.skipSkills) await prompter.note("Skipping skills setup.", "Skills");
		...
		const { setupSkills } = await import("./onboard-skills-DB3glT4L.js").then((n) => n.t);
	...
	await writeConfigFile(nextConfig);
	const { finalizeOnboardingWizard } = await import("./onboarding.finalize-CoquOYG8.js");
