import { A as theme, M as getLogger, N as getResolvedLoggerSettings, O as colorize, S as logVerbose, a as setConsoleSubsystemFilter, j as getChildLogger, k as isRich, n as runtimeForLogger, o as setConsoleTimestampPrefix, p as defaultRuntime, t as createSubsystemLogger, w as setVerbose } from "./subsystem-DVwhOlEq.js";
...
import { $n as isWebchatClient, $t as readSessionPreviewItemsFromTranscript, Bc as buildAllowedModelSet, Br as movePathToTrash, C as normalizeThinkLevel, Ci as ensureGatewayStartupAuth, Cn as resolveAgentMainSessionKey, Co as migrateLegacyConfig, Ct as extractDeliveryInfo, D as supportsXHighThinking, Da as mergeAlsoAllowPolicy, Dt as archiveRemovedSessionTranscripts, Ei as resolveConfiguredSecretInputString, En as resolveMainSessionKeyFromConfig, Fa as resolveCoreToolProfiles, Fi as resolveGatewayAuth, Fr as createBrowserControlContext, Gi as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, Hi as readGatewayPasswordEnv, Hr as ensurePortAvailable, Ht as deliveryContextFromSession, I as estimateBase64DecodedBytes, Ir as startBrowserControlServiceFromConfig, Ji as createAuthRateLimiter, Jn as isDeliverableMessageChannel, Jt as archiveFileOnDisk, Kc as isCliProvider, Ki as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, Kt as normalizeSessionDeliveryFields, Lo as writeConfigFile, Ma as PROFILE_OPTIONS, Mi as authorizeHttpGatewayConnect, Mo as readConfigFileSnapshot, Ni as authorizeWsControlUiGatewayConnect, No as readConfigFileSnapshotForWrite, On as snapshotSessionOrigin, Oo as loadConfig, Ot as loadSessionStore, Pa as listCoreToolSections, Pi as isLocalDirectRequest, Po as resolveConfigSnapshotHash, Pr as createBrowserRouteDispatcher, Pt as updateSessionStore, Qc as resolveAllowedModelRef, Qi as isLoopbackHost, Qr as rawDataToString, Qt as readSessionMessages, Ro as validateConfigObjectWithPlugins, S as normalizeReasoningLevel, Sn as canonicalizeMainSessionAlias, T as normalizeVerboseLevel, Ta as collectExplicitAllowlist, Ti as mergeGatewayTailscaleConfig, Tn as resolveMainSessionKey, To as createConfigIO, Ui as readGatewayTokenEnv, Ur as inspectPortUsage, Wc as getModelRefStatus, Wt as mergeDeliveryContext, Xi as isLocalishHost, Xn as isGatewayMessageChannel, Xt as capArrayByJsonBytes, Yc as normalizeModelSelection, Yi as normalizeRateLimitClientIp, Yn as isGatewayCliClient, Yt as archiveSessionTranscripts, Zi as isLoopbackAddress, Zt as cleanupArchivedSessionTranscripts, _ as formatThinkingLevels, _c as resolveAgentMaxConcurrent, _r as writeJsonAtomic, _u as DEFAULT_PROVIDER, aa as resolveGatewayBindHost, al as resolveSubagentConfiguredModelSelection, an as stripInlineDirectiveTagsForDisplay, ar as GATEWAY_CLIENT_IDS, ca as pickPrimaryTailnetIPv4, cr as hasGatewayClientCap, cs as isAvatarHttpUrl, da as disableTailscaleFunnel, dn as jsonUtf8Bytes, ea as isTrustedProxyAddress, ei as cleanOldMedia, el as resolveConfiguredModelRef, es as parseByteSize, fa as disableTailscaleServe, fi as SsrFBlockedError, ga as getTailnetHostname, gc as buildTalkConfigResponse, gr as readJsonFile, gu as DEFAULT_MODEL, hn as resolveSessionResetPolicy, hr as createAsyncLock, ia as resolveClientIp, ic as ensureControlUiAllowedOriginsForNonLoopbackBind, ir as GATEWAY_CLIENT_CAPS, ja as resolveToolProfilePolicy, ji as assertGatewayAuthConfigured, jo as readBestEffortConfig, ko as parseConfigJson5, la as pickPrimaryTailnetIPv6, lr as normalizeGatewayClientMode, ls as isAvatarImageDataUrl, ma as enableTailscaleServe, na as normalizeHostHeader, nc as applyMergePatch, nl as resolveHooksGmailModel, nn as stripEnvelopeFromMessage, oa as resolveGatewayListenHosts, on as stripInlineDirectiveTagsFromMessageForDisplay, or as GATEWAY_CLIENT_MODES, os as AVATAR_MAX_BYTES, pa as enableTailscaleFunnel, pn as evaluateSessionFreshness, pr as cleanStaleLockFiles, ps as looksLikeAvatarPath, pu as normalizeSecretInput, qi as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, qn as INTERNAL_MESSAGE_CHANNEL, qr as formatPortDiagnostics, ra as pickPrimaryLanIPv4, rc as applyLegacyMigrations, rn as stripEnvelopeFromMessages, sl as resolveThinkingDefault, sr as GATEWAY_CLIENT_NAMES, ta as isValidIPv4, tl as resolveDefaultModelForAgent, tn as resolveSessionTranscriptCandidates, tr as normalizeMessageChannel, ua as safeEqualSecret, un as normalizeInputProvenance, v as formatXHighModelHint, vc as resolveSubagentMaxConcurrent, w as normalizeUsageDisplay, wi as mergeGatewayAuthConfig, wn as resolveExplicitAgentSessionKey, wt as parseSessionThreadInfo, x as normalizeElevatedLevel, xn as setSessionRuntimeModel, yn as mergeSessionEntry, zc as isPidAlive, zo as OpenClawSchema } from "./auth-profiles-MKCH-k1W.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { C as DEFAULT_MEMORY_FILENAME, D as ensureAgentWorkspace, E as DEFAULT_USER_FILENAME, M as resolveWorkspaceTemplateDir, S as DEFAULT_MEMORY_ALT_FILENAME, T as DEFAULT_TOOLS_FILENAME, _ as DEFAULT_AGENTS_FILENAME, a as resolveAgentDir, b as DEFAULT_HEARTBEAT_FILENAME, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, h as resolveSessionAgentId, i as resolveAgentConfig, j as resolveDefaultAgentWorkspaceDir, k as isWorkspaceOnboardingCompleted, l as resolveAgentModelFallbacksOverride, n as listAgentEntries, r as listAgentIds, u as resolveAgentSkillsFilter, w as DEFAULT_SOUL_FILENAME, x as DEFAULT_IDENTITY_FILENAME, y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-Cwa3GjIC.js";
...
import { E as isPlainObject, S as sleep, T as truncateUtf16Safe, n as clamp, s as ensureDir, v as resolveUserPath, x as shortenHomePath } from "./utils-0k7pUAq8.js";
...
import { t as parseDurationMs } from "./parse-duration-CypKCHTP.js";
import { A as triggerInternalHook, D as clearInternalHooks, O as createInternalHookEvent, b as canonicalizePathVariant, h as createEmptyPluginRegistry, k as registerInternalHook, t as CHANNEL_IDS, u as getActivePluginRegistry, v as PROTECTED_PLUGIN_ROUTE_PREFIXES, y as canonicalizePathForSecurity } from "./registry-C2SN0COs.js";
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot, w as isTestDefaultMemorySlotDisabled } from "./skills-ByMDztuV.js";
import { f as hasBinary } from "./frontmatter-Byi6nw9U.js";
import { U as resolveWhatsAppAccount, ct as normalizeWhatsAppTarget, g as buildChannelAccountBindings, lt as resolveChannelDefaultAccountId, n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-BgwnwmkA.js";
import { C as writeFileWithinRoot, m as SafeOpenError, r as detectMime, v as openFileWithinRoot, x as readLocalFileSafely } from "./windows-spawn-oQqooioe.js";
import { a as testRegexWithBoundedInput, i as compileSafeRegex } from "./redact-D9pXgQ9w.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-DdKgwxuM.js";
import { o as isErrno, r as formatErrorMessage } from "./errors-ChRw9MpT.js";
import "./send-Do235dnE.js";
import "./send-C24Y71GV.js";
import { $ as setCliSessionId, $n as resolveAnnounceTargetFromKey, $r as resetAllLanes, $t as normalizeGroupActivation, A as createOutboundSendDeps$1, An as extractImageContentFromSource, Ar as resolveUserTimezone, At as normalizeRequiredName, Br as resolveTtsPrefsPath, Bt as applyBrowserProxyPaths, Cr as resolveFailoverReasonFromError, Ct as normalizeCronJobCreate, D as resolveAgentOutboundTarget, Dn as DEFAULT_INPUT_IMAGE_MIMES, Dt as normalizeOptionalSessionKey, E as resolveAgentDeliveryPlan, En as DEFAULT_INPUT_IMAGE_MAX_BYTES, Er as resolveAgentIdentity, Et as normalizeOptionalAgentId, Fn as resolveSendPolicy, Fr as isTtsEnabled, Ft as buildSafeExternalPrompt, Gn as initSubagentRegistry, Gr as OPENAI_TTS_MODELS, Hn as countActiveDescendantRuns, Hr as setTtsEnabled, Ht as resolveSessionAuthProfileOverride, Ir as isTtsProviderConfigured, It as detectSuspiciousPatterns, J as createReplyDispatcher, Jr as enqueueCommandInLane, Jt as applyVerboseOverride, Kr as OPENAI_TTS_VOICES, Lr as resolveTtsApiKey, Lt as getHookType, Mn as resolveInputFileLimits, Mr as clearBootstrapSnapshot, Mt as normalizeLegacyDeliveryInput, Nr as clearBootstrapSnapshotOnSessionRollover, O as createOutboundSendDeps, On as DEFAULT_INPUT_TIMEOUT_MS, Ot as normalizeOptionalText, P as resolveAgentAvatar, Pn as normalizeSendPolicy, Pr as getTtsProvider, Q as getCliSessionId, Qn as resolveAgentTimeoutMs, Qr as markGatewayDraining, Qt as unbindThreadBindingsBySessionKey, R as createReplyPrefixOptions, Rn as isAbortRequestText, Rr as resolveTtsAutoMode, Rt as isExternalHookSession, S as resolveExecApprovalCommandDisplay, St as normalizeHttpWebhookUrl, Tr as resolveAgentSessionDirs, Ur as setTtsProvider, Vr as resolveTtsProviderOrder, Vt as persistBrowserProxyFiles, Wr as textToSpeech, Xt as normalizeSpawnedRunMetadata, Y as getTotalPendingReplies, Yr as getActiveTaskCount, Yt as parseVerboseOverride, Z as buildBareSessionResetPrompt, Zr as getTotalQueueSize, Zt as resolveIngressWorkspaceOverrideForSpawnedRun, _ as handleSlackHttpRequest, _r as onAgentEvent, _t as formatRestartSentinelMessage, ai as stripHeartbeatToken, an as formatZonedTimestamp, ar as runEmbeddedPiAgent, bn as setHeartbeatsEnabled, cr as waitForActiveEmbeddedRuns, ct as resolveSessionDeliveryTarget, dr as resolveCronStyleNow, dt as maybeResolveIdLikeTarget, ei as setCommandLaneConcurrency, er as readLatestAssistantReply, et as runCliAgent, fr as runBeforeToolCallHook, ft as resetDirectoryCache, gr as getAgentRunContext, gt as formatDoctorNonInteractiveHint, h as resolveAgentOutboundIdentity, hr as emitAgentEvent, ht as consumeRestartSentinel, i as buildDefaultToolPolicyPipelineSteps, ir as buildOutboundSessionContext, it as resolveOutboundSessionRoute, jn as normalizeMimeList, k as createDefaultDeps, kn as extractFileContentFromSource, kt as normalizePayloadToSystemText, l as loadOpenClawPlugins, lr as waitForEmbeddedPiRunEnd, lt as resolveOutboundChannelPlugin, mn as isSystemEventContextChanged, mr as clearAgentRunContext, mt as runWithModelFallback, n as resolveToolLoopDetectionConfig, ni as CommandLane, o as getPluginToolMeta, or as abortEmbeddedPiRun, p as buildTelegramExecApprovalButtons, pn as enqueueSystemEvent, pr as buildExecApprovalPendingReplyPayload, q as dispatchInboundMessage, qn as listDescendantRunsForRequester, qt as applyModelOverrideToSessionEntry, r as applyToolPolicyPipeline, rr as clearSessionQueues, rt as ensureOutboundSessionEntry, s as resolvePluginTools, sr as getActiveEmbeddedRunCount, st as resolveOutboundTarget, ti as waitForActiveTasks, tn as loadProviderUsageSummary, tr as resolveNestedAgentLane, tt as createOpenClawTools, u as createPluginRuntime, v as readJsonBodyWithLimit, vn as requestHeartbeatNow, vr as registerAgentRunContext, w as agentCommandFromIngress, wr as getAcpSessionManager, wt as normalizeCronJobPatch, xr as resolveBootstrapWarningSignaturesSeen, xt as writeRestartSentinel, y as requestBodyErrorToText, yt as summarizeRestartSentinel, z as buildHistoryContextFromEntries, zn as stopSubagentsForRequester, zr as resolveTtsConfig, zt as closeTrackedBrowserTabsForSessions } from "./compact-1mmJ_KWL.js";
import { c as resolveStorePath, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-a7Rsgqtt.js";
import "./chat-envelope-B-k0pbMu.js";
import "./models-config-B-Y0EbqA.js";
import { i as isSilentReplyText, n as SILENT_REPLY_TOKEN } from "./tokens-T07bZqlD.js";
import { n as getMachineDisplayName } from "./with-timeout-BCVMjnwr.js";
import { M as getGlobalHookRunner, P as runGlobalGatewayStopSafely, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-CVgq6pew.js";
import { d as startDiagnosticHeartbeat, f as stopDiagnosticHeartbeat, h as isDiagnosticsEnabled } from "./diagnostic-Dr1BHX9Y.js";
import { C as resolveCronStorePath, S as loadCronStore, u as sendTypingTelegram, w as saveCronStore } from "./send-BBhcyCkK.js";
import "./pi-model-discovery-Bf398l7Q.js";
import "./exec-approvals-allowlist-BgPONmvb.js";
import "./exec-safe-bin-runtime-policy-kbuxCUY1.js";
import { n as loadModelCatalog } from "./model-catalog-DpydombN.js";
import "./fetch-C-eS-y1c.js";
import { v as registerUnhandledRejectionHandler } from "./audio-transcription-runner-CAaIExVC.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-CBQYpTN6.js";
import { x as extractTextFromChatContent } from "./image-BYrAeHdw.js";
import "./tool-display-DKBRElit.js";
import "./api-key-rotation-Cv5-rt6-.js";
import "./proxy-fetch-mS8YHgqh.js";
import "./ir-Cc60Bzvp.js";
import "./render-Cw_ARYQd.js";
import { a as ToolInputError } from "./target-errors-BXu-smUH.js";
import { r as isRestartEnabled } from "./commands-CQ8J-rP7.js";
import "./commands-registry-CiyfJji4.js";
import { c as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as deriveSessionTotalTokens, t as discoverAllSessions } from "./session-cost-usage-15uZ2Vrs.js";
...
import "./sqlite-B831EcXc.js";
import { $ as validateDeviceTokenRevokeParams, $t as errorShape, A as validateChatAbortParams, At as validateSessionsDeleteParams, B as validateConfigSetParams, Bt as validateSkillsUpdateParams, C as validateAgentsFilesGetParams, Ct as validatePollParams, D as validateAgentsUpdateParams, Dt as validateSecretsResolveResult, E as validateAgentsListParams, Et as validateSecretsResolveParams, F as validateConfigGetParams, Ft as validateSessionsResolveParams, G as validateCronRunParams, Gt as validateWakeParams, H as validateCronAddParams, Ht as validateTalkModeParams, I as validateConfigPatchParams, It as validateSessionsUsageParams, J as validateCronUpdateParams, Jt as validateWizardCancelParams, K as validateCronRunsParams, Kt as validateWebLoginStartParams, L as validateConfigSchemaLookupParams, Lt as validateSkillsBinsParams, M as validateChatInjectParams, Mt as validateSessionsPatchParams, N as validateChatSendParams, Nt as validateSessionsPreviewParams, O as validateChannelsLogoutParams, Ot as validateSendParams, P as validateConfigApplyParams, Pt as validateSessionsResetParams, Q as validateDevicePairRemoveParams, Qt as ErrorCodes, R as validateConfigSchemaLookupResult, Rt as validateSkillsInstallParams, S as validateAgentsDeleteParams, St as validateNodeRenameParams, T as validateAgentsFilesSetParams, Tt as validateRequestFrame, U as validateCronListParams, Ut as validateToolsCatalogParams, V as validateConnectParams, Vt as validateTalkConfigParams, W as validateCronRemoveParams, Wt as validateUpdateRunParams, X as validateDevicePairListParams, Xt as validateWizardStartParams, Y as validateDevicePairApproveParams, Yt as validateWizardNextParams, Z as validateDevicePairRejectParams, Zt as validateWizardStatusParams, _ as formatValidationErrors, _t as validateNodePairRequestParams, an as buildDeviceAuthPayloadV3, at as validateExecApprovalsNodeSetParams, b as validateAgentWaitParams, bt as validateNodePendingDrainParams, c as ADMIN_SCOPE$3, cn as normalizeDeviceAuthScopes, ct as validateModelsListParams, dt as validateNodeInvokeParams, en as parseSessionLabel, et as validateDeviceTokenRotateParams, f as WRITE_SCOPE, fn as normalizeDevicePublicKeyBase64Url, ft as validateNodeInvokeResultParams, gt as validateNodePairRejectParams, ht as validateNodePairListParams, in as buildDeviceAuthPayload, it as validateExecApprovalsNodeGetParams, j as validateChatHistoryParams, jt as validateSessionsListParams, k as validateChannelsStatusParams, kt as validateSessionsCompactParams, l as APPROVALS_SCOPE$1, ln as loadGatewayTlsRuntime$1, lt as validateNodeDescribeParams, m as isNodeRoleMethod, mt as validateNodePairApproveParams, n as callGateway, nn as resolveAuthConnectErrorDetailCode, nt as validateExecApprovalResolveParams, on as normalizeDeviceMetadataForAuth, ot as validateExecApprovalsSetParams, p as authorizeOperatorScopesForMethod, pn as verifyDeviceSignature, pt as validateNodeListParams, q as validateCronStatusParams, qt as validateWebLoginWaitParams, rn as resolveDeviceAuthConnectErrorDetailCode, rt as validateExecApprovalsGetParams, st as validateLogsTailParams, tn as ConnectErrorDetailCodes, tt as validateExecApprovalRequestParams, u as PAIRING_SCOPE$1, un as deriveDeviceIdFromPublicKey, ut as validateNodeEventParams, v as validateAgentIdentityParams, vt as validateNodePairVerifyParams, w as validateAgentsFilesListParams, wt as validatePushTestParams, x as validateAgentsCreateParams, xt as validateNodePendingEnqueueParams, y as validateAgentParams, yt as validateNodePendingAckParams, z as validateConfigSchemaParams, zt as validateSkillsStatusParams } from "./call-rN1k4f-b.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-Bq4sMN0R.js";
import "./fetch-D3omNo4J.js";
import { a as readChannelAllowFromStoreSync } from "./pairing-store-CMMWfOlm.js";
import { _ as saveExecApprovals, c as normalizeExecApprovals, f as readExecApprovalsSnapshot, o as mergeExecApprovalsSocketDefaults, r as ensureExecApprovals, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-Bukn_2nB.js";
import { h as resolveSystemRunApprovalRuntimeContext, m as resolveSystemRunApprovalRequestContext } from "./nodes-screen-9wihYzV3.js";
import { a as markGatewaySigusr1RestartHandled, c as setPreRestartDeferralCheck, i as isGatewaySigusr1RestartExternallyAllowed, l as triggerOpenClawRestart, n as deferGatewayRestartUntilIdle, o as scheduleGatewaySigusr1Restart, r as emitGatewayRestart, s as setGatewaySigusr1RestartPolicy, t as consumeGatewaySigusr1RestartAuthorization, u as cleanStaleGatewayProcessesSync } from "./restart-DqS_mqW2.js";
import { a as missingSystemRunApprovalBinding, i as matchSystemRunApprovalBinding, n as resolveSystemRunCommandRequest, r as buildSystemRunApprovalBinding, s as toSystemRunApprovalMismatchError } from "./system-run-command-CK9XrWCE.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-D3daoItF.js";
import { _ as updatePairedNodeMetadata, a as getRemoteSkillEligibility, b as getSkillsSnapshotVersion, c as refreshRemoteBinsForConnectedNodes, d as setSkillsRemoteRegistry, f as approveNodePairing, g as requestNodePairing, h as renamePairedNode, l as refreshRemoteNodeBins, m as rejectNodePairing, o as primeRemoteSkillsCache, p as listNodePairing, s as recordRemoteNodeInfo, u as removeRemoteNodeInfo, v as verifyNodeToken, x as registerSkillsChangeListener } from "./skill-commands-Cx5nOzJG.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-CERYhVI4.js";
import "./pairing-token-BQ0EAxXy.js";
import { t as getChannelActivity } from "./channel-activity-aUe3vPRD.js";
import { n as normalizePollInput } from "./polls-187lf1Zd.js";
import "./tables-htXeeZkO.js";
import { i as evaluateGatewayAuthSurfaceStates, m as isKnownSecretTargetId, r as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-web-tools-_ys1IFlV.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot, n as clearSecretsRuntimeSnapshot, o as resolveCommandSecretsFromActiveRuntimeSnapshot, t as activateSecretsRuntimeSnapshot } from "./runtime-D26OuUH3.js";
import { i as parseAbsoluteTimeMs, n as resolveCronStaggerMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-DQPqqyh6.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-IGFCHpWu.js";
import { i as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-Bg70yf8z.js";
import "./send-AUgx_RU1.js";
import "./outbound-attachment-DP5mKTXm.js";
import "./delivery-queue-DESfaI1q.js";
import "./send-BCRbj8iN.js";
import "./fetch-BG6pJhZn.js";
import "./timeouts-Z85FZrUV.js";
import "./command-secret-targets-B4IzDSdV.js";
import "./connection-auth-Bm2DtMF6.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-Brn1u_2n.js";
import "./prompt-style-DoUbK5fH.js";
import "./pairing-labels-CadgBB0z.js";
import { r as resolveMemoryBackendConfig, t as getMemorySearchManager } from "./search-manager-YVuEXd-D.js";
import { a as resolveMemorySearchConfig } from "./manager-mlu25MUh.js";
import "./memory-cli-0EUMX3gi.js";
import { t as formatDocsLink } from "./links-BNP-f5t1.js";
import { n as runCommandWithRuntime } from "./cli-utils-nB6lHuak.js";
import { t as formatHelpExamples } from "./help-format-BysmLRMx.js";
import { n as withProgress } from "./progress-CNsW4QH6.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-20tRo9Jk.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-CknY-eGY.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-CNAlsGyG.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-vX2CjH4n.js";
import { t as readSecretFromFile } from "./secret-file-BwbsoR3N.js";
import { n as inheritOptionFromParent } from "./command-options-B6in0Ycw.js";
import { t as WizardCancelledError } from "./prompts-CYx67zxq.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-CyDFbyYG.js";
import { t as isWithinDir } from "./path-safety-Vh9u9xyY.js";
import "./install-safe-path-xC--QTS5.js";
import "./skill-scanner-B8fsywKI.js";
import { n as formatConfigIssueLines } from "./issue-format-BxaIt2aZ.js";
import { t as buildChannelAccountSnapshot } from "./status-CuF8Vvto.js";
import "./channels-status-issues-ByBXLFLS.js";
import { a as buildBaseHints, i as applySensitiveHints, n as redactConfigSnapshot, o as mapSensitivePaths, r as restoreRedactedValues, s as applyDerivedTags, t as redactConfigObject } from "./redact-snapshot-BKdseG7P.js";
import "./daemon-install-plan.shared-DdGjoRZK.js";
import "./runtime-guard-Deu-vbXy.js";
import "./gateway-install-token-Bpt4OIVL.js";
import "./systemd-CcwWmJAp.js";
import { u as scheduleDetachedLaunchdRestartHandoff } from "./service-B9XdMNnP.js";
import "./lifecycle-core-XTqnJ4EA.js";
import "./systemd-hints-CCGfNoXz.js";
import { t as parsePort$1 } from "./parse-port-D7sJcuOK.js";
import { c as parseProcCmdline, n as addGatewayServiceCommands, s as isGatewayArgv } from "./daemon-cli-rhROJBpI.js";
import { r as probeGateway } from "./probe-auth-CG63VGFa.js";
import "./diagnostics-DLNV1ovA.js";
import { a as rejectDevicePairing, c as revokeDeviceToken, d as updatePairedDeviceMetadata, f as verifyDeviceToken, i as listDevicePairing, l as rotateDeviceToken, n as ensureDeviceToken, o as removePairedDevice, p as roleScopesAllow, r as getPairedDevice, s as requestDevicePairing, t as approveDevicePairing, u as summarizeDeviceTokens } from "./device-pairing-BgGqOIku.js";
import "./table-wQWPGQtd.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-DNVkHw60.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-DlAS6r6m.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-DLgi9zPg.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-BGAnd-sp.js";
import { a as styleHealthChannelLine, c as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-BxAgqqNt.js";
import { a as resolveControlUiRootOverrideSync, n as isPackageProvenControlUiRootSync, o as resolveControlUiRootSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-bcmHPAUF.js";
import { m as normalizeUpdateChannel, n as checkUpdateStatus, o as resolveNpmChannelTag, r as compareSemverStrings } from "./channel-account-context-Cdd6cUnK.js";
import "./onboarding.secret-input-7q4cWfrg.js";
import { t as runOnboardingWizard } from "./onboarding-COhyS4V7.js";
import { a as sendApnsAlert, c as parseMessageWithAttachments, d as shouldLogWs, f as summarizeAgentEventForWsLog, i as resolveApnsAuthConfigFromEnv, l as formatForLog, n as normalizeApnsEnvironment, o as sendApnsBackgroundWake, p as setGatewayWsLogStyle, s as normalizeRpcAttachmentsToChatAttachments, t as loadApnsRegistration, u as logWs } from "./push-apns-CmkteIjM.js";
...
import { d as coerceFiniteScheduleNumber, f as computeNextRunAtMs, p as computePreviousRunAtMs, t as runGatewayUpdate, u as normalizeStoredCronJobs } from "./update-runner-CsfK3SMx.js";
import { n as isNodeCommandAllowed, r as resolveNodeCommandAllowlist } from "./node-command-policy-D85H0DhX.js";
import { n as collectEnabledInsecureOrDangerousFlags } from "./audit-Cy9Idnvr.js";
import "./node-service-BoAzqqxP.js";
import "./status.update-CirtdeT2.js";
import { t as installSkill } from "./skills-install-BNmdj_5K.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-BrzVPfao.js";
import { n as forceFreePortAndWait, r as waitForPortBindable } from "./ports-Er5idNo8.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BsNdhHQI.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-15uZ2Vrs.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-CjwBYRb1.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-DESfaI1q.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-CVgq6pew.js").then((n) => n.n);
