...
import { Ct as openUrl, Dt as resolveControlUiLinks, Tt as probeGatewayReachable, _t as formatControlUiSshHint, ht as detectBrowserOpenSupport, jt as waitForGatewayReachable } from "./auth-profiles-iXW75sRj.js";
...
import { t as runTui } from "./tui-NdfHeDc_.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-CXwRlUdQ.js").then((n) => n.r);
