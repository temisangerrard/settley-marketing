import { Dt as resolveAgentModelPrimaryValue, Et as resolveAgentModelFallbackValues, P as redactToolDetail } from "./paths-Ckw4WcFk.js";
import { As as resolveImplicitProviders, _a as loadConfig, bs as normalizeModelRef, fs as resolveOpenClawAgentDir, ft as sanitizeUserFacingText, ga as getRuntimeConfigSourceSnapshot, ks as normalizeProviders, n as requireApiKey, qs as normalizeSecretInput, rs as createConfigRuntimeEnv, t as getApiKeyForModel, va as projectConfigOntoRuntimeSourceSnapshot, zs as isNonSecretApiKeyMarker } from "./model-auth-DkZtfSM9.js";
import { f as isRecord, x as shortenHomeInString } from "./logger-D7LwrCL0.js";
...
function loadPiModelDiscoveryRuntime() {
	piModelDiscoveryRuntimePromise ??= import("./pi-model-discovery-runtime-BgPb6aFg.js");
