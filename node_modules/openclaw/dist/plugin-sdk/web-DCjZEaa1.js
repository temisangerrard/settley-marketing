import { gt as buildAgentMainSessionKey, ht as DEFAULT_MAIN_KEY, s as resolveStorePath, vt as buildGroupHistoryKey, xt as normalizeAgentId } from "./paths-aoI9lHOB.js";
import { B as shouldLogVerbose, K as getChildLogger, M as defaultRuntime, O as createSubsystemLogger, R as logVerbose, d as normalizeE164, l as isSelfChatMode, m as resolveJidToE164, n as clamp, u as jidToE164, x as toWhatsappJid, y as sleep } from "./utils-U4csWGdS.js";
import "./paths-Dmn791zP.js";
import { Bn as resolveChannelGroupPolicy, Er as saveMediaBuffer, Gn as resolveGroupSessionKey, Gs as logWebSelfId, Hi as loadConfig, Hs as resolveWhatsAppMediaMaxBytes, Js as pickWebChannel, St as recordSessionMetaFromInbound, Us as WA_WEB_AUTH_DIR, Vn as resolveChannelGroupRequireMention, Vs as resolveWhatsAppAccount, Ws as getWebAuthAgeMs, Xs as readWebSelfId, bt as loadSessionStore, ec as webAuthExists, sc as formatCliCommand, wt as updateLastRoute } from "./model-auth-CTzD-epg.js";
import "./target-errors-AyvbVU-y.js";
import { A as computeBackoff, B as resolveInboundLastRouteSessionKey, C as resolveInboundDebounceMs, D as buildMentionRegexes, E as shouldComputeCommandAuthorized, F as formatDurationPrecise, G as resolveDmGroupAccessWithLists, I as enqueueSystemEvent, K as resolvePinnedMainDmOwnerFromAllowlist, L as buildAgentSessionKey, M as createDedupeCache, N as normalizeGroupActivation, O as normalizeMentionText, P as parseActivationCommand, R as deriveLastRoutePolicy, S as createInboundDebouncer, T as hasControlCommand, U as readStoreAllowFromForDmPolicy, V as finalizeInboundContext, W as resolveDmGroupAccessWithCommandGate, X as resolveIdentityNamePrefix, Y as createReplyPrefixOptions, Z as resolveMessagePrefix, _ as buildHistoryContextFromEntries, b as dispatchReplyWithBufferedBlockDispatcher, g as resolveMentionGating, h as createConnectedChannelStatusPatch, j as sleepWithAbort, m as resolveInboundSessionEnvelopeContext, q as issuePairingChallenge, r as getReplyFromConfig, v as recordPendingHistoryEntryIfEnabled, w as formatInboundEnvelope, y as shouldAckReactionForWhatsApp, z as resolveAgentRoute } from "./dispatch-4PYvcEOv.js";
import { $ as upsertChannelPairingRequest, ct as formatLocationText, lt as toLocationContext } from "./send-_-FQgtt7.js";
import { Mt as resolveDefaultGroupPolicy, Nt as resolveOpenProviderRuntimeGroupPolicy, Pt as warnMissingProviderGroupPolicyFallbackOnce } from "./send-WfiHbr9S.js";
import "./proxy-env-I4fYsp6I.js";
import "./github-copilot-token-B8UEBIjq.js";
import "./send-Cx455Kd4.js";
import "./fetch-guard-DUN7X0K7.js";
import "./deliver-CC4WNwqc.js";
import "./diagnostic-On3MKd62.js";
import "./pi-model-discovery-DKV4hqMA.js";
import { f as registerUnhandledRejectionHandler } from "./audio-transcription-runner-CJ7nYvXU.js";
import "./image-2c-vkR8y.js";
import "./api-key-rotation-UhITdGL_.js";
import { t as getAgentScopedMediaLocalRoots } from "./local-roots-brkwYz_C.js";
import "./proxy-fetch-CJ2KJ1Hc.js";
import "./tokens-DOkkLn5z.js";
import "./commands-registry-C9TLus2U.js";
import { a as loadWebMedia, d as chunkMarkdownTextWithMode, h as resolveTextChunkLimit, m as resolveChunkMode, s as resolveMarkdownTableMode } from "./ir-C1s8-YMk.js";
import "./render-CDecAPNW.js";
import "./send-DzkJeHQb.js";
import "./outbound-attachment-fCu-0WJK.js";
import "./fetch-DdpSxwwg.js";
import "./send-DLt7YqCA.js";
import "./sqlite-DlSne7IK.js";
import { n as recordChannelActivity } from "./channel-activity-Nmm3FIxp.js";
import { t as convertMarkdownTables } from "./tables-DjImWKeK.js";
import "./fetch-BcalEYTl.js";
import "./skill-commands-DRlejhBc.js";
import { r as setActiveWebListener } from "./active-listener-BgI24uFC.js";
import "./manager-CL4nxPdE.js";
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-fK6a3FTA.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-BMouCMzu.js";
import { t as loginWeb } from "./login-DGdiAmzx.js";
