import { Dt as resolveAgentModelPrimaryValue, Et as resolveAgentModelFallbackValues, f as getFileExtension, g as kindFromMime, m as isAudioFileName, u as detectMime, ut as runExec } from "./paths-CgQkARJB.js";
import { Fa as resolveIMessageAttachmentRoots, Ma as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, Ms as normalizeGoogleModelId, Na as isInboundPathAllowed, Pa as mergeInboundPathRoots, Ts as normalizeProviderId, gs as resolveOpenClawAgentDir, n as requireApiKey, r as resolveApiKeyForProvider, vr as normalizeChatType, xa as loadConfig } from "./model-auth-BfsjuQOC.js";
import { B as shouldLogVerbose, O as createSubsystemLogger, R as logVerbose, Z as resolvePreferredOpenClawTmpDir } from "./logger-CsFArJhx.js";
import { n as fetchWithTimeout } from "./fetch-timeout-CmQnOXfj.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-CDwl0iBG.js";
import { t as describeImageWithModel, w as ensureOpenClawModelsJson } from "./image-kypvCrBp.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-CG8i3Tkm.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-BIw_Fwyo.js";
import { r as resolveProxyFetchFromEnv } from "./proxy-fetch-EDm332TD.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-BKLwA-rJ.js").then((n) => n.r);
