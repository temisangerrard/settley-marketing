import { Gt as getFileExtension, Ut as detectMime, Yt as kindFromMime, ct as resolveAgentModelPrimaryValue, qt as isAudioFileName, st as resolveAgentModelFallbackValues, zt as runExec } from "./paths-aoI9lHOB.js";
import { B as shouldLogVerbose, O as createSubsystemLogger, R as logVerbose, Z as resolvePreferredOpenClawTmpDir } from "./utils-U4csWGdS.js";
import { $i as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, $o as normalizeGoogleModelId, Hi as loadConfig, Ko as normalizeProviderId, Lo as resolveOpenClawAgentDir, Wn as normalizeChatType, ea as isInboundPathAllowed, n as requireApiKey, na as resolveIMessageAttachmentRoots, r as resolveApiKeyForProvider, ta as mergeInboundPathRoots } from "./model-auth-CTzD-epg.js";
import { n as fetchWithTimeout } from "./fetch-timeout-csbOmT9G.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-DUN7X0K7.js";
import { t as describeImageWithModel, w as ensureOpenClawModelsJson } from "./image-2c-vkR8y.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-UhITdGL_.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-brkwYz_C.js";
import { r as resolveProxyFetchFromEnv } from "./proxy-fetch-CJ2KJ1Hc.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-DKV4hqMA.js").then((n) => n.r);
