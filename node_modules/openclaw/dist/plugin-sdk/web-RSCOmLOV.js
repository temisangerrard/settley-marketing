import { Ot as DEFAULT_MAIN_KEY, Pt as normalizeAgentId, jt as buildGroupHistoryKey, kt as buildAgentMainSessionKey, s as resolveStorePath } from "./paths-BVXyNncL.js";
import "./paths-DinMprTu.js";
import { B as shouldLogVerbose, C as sleep, K as getChildLogger, M as defaultRuntime, O as createSubsystemLogger, R as logVerbose, T as toWhatsappJid, h as normalizeE164, m as jidToE164, o as clamp, p as isSelfChatMode, v as resolveJidToE164 } from "./logger-Dpa88cUs.js";
import { $n as saveMediaBuffer, As as resolveWhatsAppMediaMaxBytes, Dt as recordSessionMetaFromInbound, Hs as webAuthExists, Is as pickWebChannel, Ks as formatCliCommand, Ms as getWebAuthAgeMs, Ns as logWebSelfId, Rs as readWebSelfId, Tt as loadSessionStore, cc as resolveChannelGroupPolicy, fn as resolveGroupSessionKey, hi as loadConfig, js as WA_WEB_AUTH_DIR, ks as resolveWhatsAppAccount, kt as updateLastRoute, lc as resolveChannelGroupRequireMention } from "./model-auth-4L-d39tw.js";
import "./proxy-env-Bpki4ye4.js";
import "./send-BnEeDbR9.js";
import { Ft as warnMissingProviderGroupPolicyFallbackOnce, Nt as resolveDefaultGroupPolicy, Pt as resolveOpenProviderRuntimeGroupPolicy } from "./send-DUB3xoaC.js";
import { A as parseActivationCommand, B as resolveDmGroupAccessWithCommandGate, C as hasControlCommand, D as sleepWithAbort, E as computeBackoff, F as resolveAgentRoute, I as resolveInboundLastRouteSessionKey, J as resolveIdentityNamePrefix, L as finalizeInboundContext, M as enqueueSystemEvent, N as buildAgentSessionKey, O as createDedupeCache, P as deriveLastRoutePolicy, S as formatInboundEnvelope, U as resolvePinnedMainDmOwnerFromAllowlist, V as resolveDmGroupAccessWithLists, Y as resolveMessagePrefix, Z as resolveMentionGating, _ as shouldAckReactionForWhatsApp, b as createInboundDebouncer, ct as buildMentionRegexes, g as issuePairingChallenge, h as createConnectedChannelStatusPatch, it as buildHistoryContextFromEntries, j as formatDurationPrecise, k as normalizeGroupActivation, lt as normalizeMentionText, m as resolveInboundSessionEnvelopeContext, q as createReplyPrefixOptions, r as getReplyFromConfig, st as recordPendingHistoryEntryIfEnabled, v as dispatchReplyWithBufferedBlockDispatcher, w as shouldComputeCommandAuthorized, x as resolveInboundDebounceMs, z as readStoreAllowFromForDmPolicy } from "./dispatch-D1dE7Hll.js";
import "./tokens-BqQv5Gml.js";
import "./deliver-aQrIccnr.js";
import "./github-copilot-token-CHD9No4C.js";
import "./fetch-guard-jLT-MYqq.js";
import { X as toLocationContext, Y as formatLocationText, tt as upsertChannelPairingRequest } from "./send-ocWkyEar.js";
import { t as getAgentScopedMediaLocalRoots } from "./local-roots-B4NGHvIh.js";
import { _ as loadWebMedia, c as chunkMarkdownTextWithMode, d as resolveChunkMode, f as resolveTextChunkLimit, i as resolveMarkdownTableMode } from "./ir-DAYDilSD.js";
import "./diagnostic-DJapFgPt.js";
import "./pi-model-discovery-B2twiKlT.js";
import { f as registerUnhandledRejectionHandler } from "./audio-transcription-runner-a2xQeH_j.js";
import "./image-Dw7iNfZw.js";
import "./api-key-rotation-Bqup0scz.js";
import "./proxy-fetch-3280-rO9.js";
import "./commands-registry-Cf6U67LS.js";
import "./render-Cky8fVYO.js";
import "./target-errors-L33AQnqz.js";
import "./send-CDBF-ueA.js";
import "./outbound-attachment-uwsVUo7V.js";
import "./fetch-DdpSxwwg.js";
import "./send-C9IJ0iKV.js";
import "./sqlite-bc7R52rq.js";
import { n as recordChannelActivity } from "./channel-activity-y5ryguFs.js";
import { t as convertMarkdownTables } from "./tables-B0VelzWm.js";
import "./fetch-DJo-H8Bl.js";
import "./skill-commands-D4sse9Ig.js";
import { r as setActiveWebListener } from "./active-listener-DHszLeou.js";
import "./manager-Cha_ruNp.js";
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-BesjgoJn.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-BhPiDPJJ.js";
import { t as loginWeb } from "./login-ZBt80MIK.js";
