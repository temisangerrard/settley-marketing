import { Bt as DEFAULT_ACCOUNT_ID, Tt as normalizeStringEntries, Vt as normalizeAccountId, d as extensionForMime, f as getFileExtension, u as detectMime } from "./paths-BVXyNncL.js";
import "./paths-DinMprTu.js";
import { C as sleep } from "./logger-Dpa88cUs.js";
import { Ci as MSTeamsConfigSchema, Ha as withFileLock, Zn as extractOriginalFilename, ac as normalizeResolvedSecretInputString, dc as resolveToolsBySender, ic as hasConfiguredSecretInput, oc as normalizeSecretInputString, vr as isPrivateIpAddress } from "./model-auth-4L-d39tw.js";
import "./proxy-env-Bpki4ye4.js";
import "./send-BnEeDbR9.js";
import { At as resolveSenderScopedGroupPolicy, Bt as resolveNestedAllowlistDecision, Lt as buildChannelKeyCandidates, Mt as resolveAllowlistProviderRuntimeGroupPolicy, Nt as resolveDefaultGroupPolicy, Rt as normalizeChannelSlug, kt as evaluateSenderGroupAccessForPolicy, zt as resolveChannelEntryMatchWithFallback } from "./send-DUB3xoaC.js";
import { $ as logTypingFailure, G as isDangerousNameMatchingEnabled, H as resolveEffectiveAllowFromLists, K as createTypingCallbacks, Q as logInboundDrop, R as formatDocsLink, V as resolveDmGroupAccessWithLists, W as DEFAULT_WEBHOOK_MAX_BODY_BYTES, X as buildMediaPayload, Z as resolveMentionGating, at as buildPendingHistoryContextFromMap, dt as resolveAllowlistMatchSimple, et as resolveControlCommandGate, m as resolveInboundSessionEnvelopeContext, n as dispatchReplyFromConfig, nt as summarizeMapping, ot as clearHistoryEntriesIfEnabled, q as createReplyPrefixOptions, rt as DEFAULT_GROUP_HISTORY_LIMIT, st as recordPendingHistoryEntryIfEnabled, t as withReplyDispatcher, tt as mergeAllowlist, ut as formatAllowlistMatchMeta, z as readStoreAllowFromForDmPolicy } from "./dispatch-D1dE7Hll.js";
import { i as isSilentReplyText, n as SILENT_REPLY_TOKEN } from "./tokens-BqQv5Gml.js";
import { P as resolveChannelMediaMaxBytes } from "./deliver-aQrIccnr.js";
import "./github-copilot-token-CHD9No4C.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-jLT-MYqq.js";
import { nt as readJsonFileWithFallback, rt as writeJsonFileAtomically } from "./send-ocWkyEar.js";
import "./local-roots-B4NGHvIh.js";
import { _ as loadWebMedia } from "./ir-DAYDilSD.js";
import "./diagnostic-DJapFgPt.js";
import "./pi-model-discovery-B2twiKlT.js";
import "./audio-transcription-runner-a2xQeH_j.js";
...
import "./channel-activity-y5ryguFs.js";
import "./tables-B0VelzWm.js";
