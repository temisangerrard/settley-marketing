import { A as createDedupeCache, B as issuePairingChallenge, C as hasControlCommand, E as normalizeMentionText, F as buildAgentSessionKey, H as readStoreAllowFromForDmPolicy, I as deriveLastRoutePolicy, J as createReplyPrefixOptions, K as resolvePinnedMainDmOwnerFromAllowlist, L as resolveAgentRoute, M as parseActivationCommand, N as formatDurationPrecise, O as computeBackoff, P as enqueueSystemEvent, R as resolveInboundLastRouteSessionKey, S as formatInboundEnvelope, T as buildMentionRegexes, U as resolveDmGroupAccessWithCommandGate, W as resolveDmGroupAccessWithLists, X as resolveMessagePrefix, Y as resolveIdentityNamePrefix, _ as shouldAckReactionForWhatsApp, b as createInboundDebouncer, f as resolveInboundSessionEnvelopeContext, g as recordPendingHistoryEntryIfEnabled, h as buildHistoryContextFromEntries, j as normalizeGroupActivation, k as sleepWithAbort, m as resolveMentionGating, p as createConnectedChannelStatusPatch, t as getReplyFromConfig, v as dispatchReplyWithBufferedBlockDispatcher, w as shouldComputeCommandAuthorized, x as resolveInboundDebounceMs, z as finalizeInboundContext } from "./dispatch-Co2ceCdc.js";
import { Lt as normalizeAgentId, Mt as buildAgentMainSessionKey, Pt as buildGroupHistoryKey, jt as DEFAULT_MAIN_KEY, s as resolveStorePath } from "./paths-Ckw4WcFk.js";
import { Bn as resolveWhatsAppMediaMaxBytes, Dt as recordSessionMetaFromInbound, Hn as getWebAuthAgeMs, Jn as readWebSelfId, Kn as pickWebChannel, Qn as webAuthExists, Qs as formatCliCommand, Tt as loadSessionStore, Un as logWebSelfId, Vn as WA_WEB_AUTH_DIR, _a as loadConfig, dr as resolveChannelGroupRequireMention, gr as resolveGroupSessionKey, kt as updateLastRoute, ni as saveMediaBuffer, ur as resolveChannelGroupPolicy, zn as resolveWhatsAppAccount } from "./model-auth-DkZtfSM9.js";
import { B as shouldLogVerbose, C as sleep, K as getChildLogger, M as defaultRuntime, O as createSubsystemLogger, R as logVerbose, T as toWhatsappJid, h as normalizeE164, m as jidToE164, o as clamp, p as isSelfChatMode, v as resolveJidToE164 } from "./logger-D7LwrCL0.js";
import "./paths-CtOdJffQ.js";
import "./proxy-env-Bkyuuf7V.js";
import "./github-copilot-token-B5aRMBY6.js";
import "./send-B5clyDuU.js";
import { Mt as resolveOpenProviderRuntimeGroupPolicy, Nt as warnMissingProviderGroupPolicyFallbackOnce, jt as resolveDefaultGroupPolicy } from "./send-DYtr8_Bk.js";
import { X as toLocationContext, Y as formatLocationText, tt as upsertChannelPairingRequest } from "./send-CE1lRPy-.js";
import "./deliver-BwU2fwl6.js";
import "./diagnostic-Ilr3UrDv.js";
import "./pi-model-discovery-cNATl5Eh.js";
import { f as registerUnhandledRejectionHandler } from "./audio-transcription-runner-DWm46_W1.js";
import "./image-Bo64Bl8w.js";
import "./fetch-guard-DcmDG0QD.js";
import "./api-key-rotation-CTyrzk8e.js";
import { t as getAgentScopedMediaLocalRoots } from "./local-roots-Czl62Z8b.js";
import "./proxy-fetch-BMl8EIih.js";
import "./tokens-CNK-FYqw.js";
import "./commands-registry-IGmEA0of.js";
import { a as loadWebMedia, d as chunkMarkdownTextWithMode, h as resolveTextChunkLimit, m as resolveChunkMode, s as resolveMarkdownTableMode } from "./ir-RD_gYo01.js";
import "./render-Cky8fVYO.js";
import "./target-errors-DsqxSrsd.js";
import "./send-BVGdwpbt.js";
import "./outbound-attachment-DQ6JGoJC.js";
import "./fetch-B-Q2OOqY.js";
import "./send-nkF1uCCm.js";
import "./sqlite-C2qDC1oT.js";
import { n as recordChannelActivity } from "./channel-activity-CLrwQV3d.js";
import { t as convertMarkdownTables } from "./tables-C5khgGip.js";
import "./fetch-BmOfZDIP.js";
import "./skill-commands-BpLTgyrO.js";
import { r as setActiveWebListener } from "./active-listener-CdilAf7M.js";
import "./manager-rkfLxLSi.js";
import { i as markdownToWhatsApp, r as sendReactionWhatsApp, t as sendMessageWhatsApp } from "./outbound-D1Il74V5.js";
import { i as waitForWaConnection, n as formatError, r as getStatusCode, t as createWaSocket } from "./session-BQP30RwO.js";
import { t as loginWeb } from "./login-C79KWMAL.js";
