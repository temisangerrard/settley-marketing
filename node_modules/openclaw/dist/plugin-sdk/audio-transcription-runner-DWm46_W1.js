import { Dt as resolveAgentModelPrimaryValue, Et as resolveAgentModelFallbackValues, f as getFileExtension, g as kindFromMime, m as isAudioFileName, u as detectMime, ut as runExec } from "./paths-Ckw4WcFk.js";
import { Aa as mergeInboundPathRoots, Oa as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, Os as normalizeGoogleModelId, _a as loadConfig, fs as resolveOpenClawAgentDir, hr as normalizeChatType, ja as resolveIMessageAttachmentRoots, ka as isInboundPathAllowed, n as requireApiKey, r as resolveApiKeyForProvider, xs as normalizeProviderId } from "./model-auth-DkZtfSM9.js";
import { B as shouldLogVerbose, O as createSubsystemLogger, R as logVerbose, Z as resolvePreferredOpenClawTmpDir } from "./logger-D7LwrCL0.js";
import { t as describeImageWithModel, w as ensureOpenClawModelsJson } from "./image-Bo64Bl8w.js";
import { n as fetchWithTimeout } from "./fetch-timeout-CNgeVGLz.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-DcmDG0QD.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-CTyrzk8e.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-Czl62Z8b.js";
import { r as resolveProxyFetchFromEnv } from "./proxy-fetch-BMl8EIih.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-cNATl5Eh.js").then((n) => n.r);
