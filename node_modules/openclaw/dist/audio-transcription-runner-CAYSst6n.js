import { Qt as resolveAgentModelPrimaryValue, Zt as resolveAgentModelFallbackValues, f as getFileExtension, g as kindFromMime, m as isAudioFileName, u as detectMime, ut as runExec } from "./paths-BVXyNncL.js";
import { B as shouldLogVerbose, O as createSubsystemLogger, R as logVerbose, Z as resolvePreferredOpenClawTmpDir } from "./logger-Dpa88cUs.js";
import { Ga as loadConfig, Ur as normalizeChatType, ao as resolveIMessageAttachmentRoots, b as resolveApiKeyForProvider, c as normalizeProviderId, h as normalizeGoogleModelId, io as mergeInboundPathRoots, no as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, qs as resolveOpenClawAgentDir, ro as isInboundPathAllowed, y as requireApiKey } from "./model-selection-DPAUAnEm.js";
import { D as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-B-9Uw3HL.js";
import { a as getDefaultMediaLocalRoots, n as fetchRemoteMedia, t as MediaFetchError } from "./fetch-C5oAaxjH.js";
import { n as fetchWithTimeout } from "./fetch-timeout-CLvR6emZ.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-6J1GNVX9.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-BUOHiZVi.js";
import { r as resolveProxyFetchFromEnv } from "./proxy-fetch-zLzZSsWR.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-C_vdPySF.js").then((n) => n.r);
