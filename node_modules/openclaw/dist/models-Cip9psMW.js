...
import { Ac as ensureAuthProfileStore, Cl as shouldEnableShellEnvFallback, Dc as upsertAuthProfile, Ec as setAuthProfileOrder, Fo as setRuntimeConfigSnapshot, Hc as buildModelAliasIndex, Ic as resolveAuthStorePathForDisplay, Lc as resolveOpenClawAgentDir, No as readConfigFileSnapshotForWrite, Oo as loadConfig, To as createConfigIO, Uc as findNormalizedProviderValue, Xc as normalizeProviderId, Zc as parseModelRef, _l as resolveEnvApiKey, _u as DEFAULT_PROVIDER, au as isNonSecretApiKeyMarker, bl as getShellEnvAppliedKeys, el as resolveConfiguredModelRef, fl as getCustomProviderApiKey, gl as resolveAwsSdkEnvVarName, gu as DEFAULT_MODEL, hl as resolveApiKeyForProvider, io as resolveSecretRefString, l as resolveProfileUnusableUntilForDisplay, n as resolveAuthProfileEligibility, pl as hasUsableCustomProviderApiKey, qc as modelKey, r as resolveAuthProfileOrder, rl as resolveModelRefFromString, tl as resolveDefaultModelForAgent, vu as resolveAuthProfileDisplayLabel, wc as listProfilesForProvider, yl as resolveUsableCustomProviderApiKey } from "./auth-profiles-MKCH-k1W.js";
import { t as formatCliCommand } from "./command-format-CO3N-oGG.js";
import { F as toAgentModelListLike, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, j as resolveDefaultAgentWorkspaceDir, l as resolveAgentModelFallbacksOverride, s as resolveAgentExplicitModelPrimary } from "./agent-scope-Cwa3GjIC.js";
...
import { Gt as buildAuthHealthSummary, Kt as formatRemainingShort, Sr as describeFailoverError, Ut as maskApiKey, Wt as DEFAULT_OAUTH_WARN_MS, ar as runEmbeddedPiAgent, in as resolveUsageProviderId, qr as resolveModelWithRegistry, rn as formatUsageWindowSummary, tn as loadProviderUsageSummary } from "./compact-1mmJ_KWL.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-a7Rsgqtt.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-Bf398l7Q.js";
import { n as loadModelCatalog } from "./model-catalog-DpydombN.js";
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-B4IzDSdV.js";
import { f as openUrl } from "./onboard-helpers-Brn1u_2n.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-DoUbK5fH.js";
import { r as withProgressTotals } from "./progress-CNsW4QH6.js";
...
import { t as inferParamBFromIdOrName } from "./model-param-b-FBDg-77m.js";
import { n as redactSecrets } from "./format-DAbjT9C6.js";
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-Cw_M4gpw.js";
import { Mt as writeOAuthCredentials, h as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-CEK88UGz.js";
import { t as isRemoteEnvironment } from "./oauth-env-uuxLUci1.js";
import { n as logConfigUpdated } from "./logging-D9cwAGmq.js";
import { a as loginOpenAICodexOAuth, i as resolveProviderMatch, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-Cp7doW-7.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles-MKCH-k1W.js").then((n) => n.t);
	const { ensureOpenClawModelsJson } = await import("./models-config-B-Y0EbqA.js").then((n) => n.n);
