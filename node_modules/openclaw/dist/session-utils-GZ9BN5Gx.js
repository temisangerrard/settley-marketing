import { nt as consumeRootOptionToken } from "./subsystem-DVwhOlEq.js";
import { g as resolveStateDir } from "./paths-BfR2LXbA.js";
import { Cn as resolveAgentMainSessionKey, Gc as inferUniqueProviderFromConfiguredModels, Gn as buildGroupDisplayName, Kt as normalizeSessionDeliveryFields, Lc as resolveOpenClawAgentDir, Oo as loadConfig, Ot as loadSessionStore, Sn as canonicalizeMainSessionAlias, Tn as resolveMainSessionKey, Zc as parseModelRef, _u as DEFAULT_PROVIDER, bn as resolveFreshSessionTotalTokens, cs as isAvatarHttpUrl, el as resolveConfiguredModelRef, en as readSessionTitleFieldsFromTranscript, fs as isWorkspaceRelativeAvatarPath, gu as DEFAULT_MODEL, ms as resolveAvatarMime, os as AVATAR_MAX_BYTES, ss as isAvatarDataUrl, tl as resolveDefaultModelForAgent, us as isPathWithinRoot } from "./auth-profiles-MKCH-k1W.js";
...
import { t as ensureOpenClawModelsJson } from "./models-config-B-Y0EbqA.js";
...
function ensureContextWindowCacheLoaded() {
	...
	loadPromise = (async () => {
		...
		try {
			const { discoverAuthStorage, discoverModels } = await import("./pi-model-discovery-Bf398l7Q.js").then((n) => n.r);
