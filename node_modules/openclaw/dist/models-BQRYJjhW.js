...
import { i as parseDurationMs } from "./search-manager-aGRM40Un.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureOpenClawModelsJson } = await import("./auth-profiles-iXW75sRj.js").then((n) => n.jg);
