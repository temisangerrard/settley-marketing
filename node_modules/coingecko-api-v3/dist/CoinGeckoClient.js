...
class CoinGeckoClient {
  ...
  valid values: true, false
    ...
    coinCategoriesList() {
        return __awaiter(this, void 0, void 0, function* () {
            return this.makeRequest(Enum_1.API_ROUTES.COIN_CATEGORIES_LIST);
        });
    }
    /**
     ...
     * @returns {Array<Category>}
     */
    coinCategoriesListWithMarketData() {
        return __awaiter(this, arguments, void 0, function* (input = {}) {
            return this.makeRequest(Enum_1.API_ROUTES.COIN_CATEGORIES, input);
        });
    }
    /**
