...
import { IndexItem, CoinListResponseItem, CoinMarket, PingResponse, TrendingResponse, SimplePriceResponse, TokenPriceResponse, CoinFullInfo, CoinTickerResponse, CoinHistoryResponse, CoinMarketChartResponse, Exchange, NameIdPair, ExchangeId, ExchangeIdTickerResponse, FinancePlatform, Derivative, DerivativeExchange, ExchangeRatesResponse, GlobalResponse, GlobalDefiResponse, Options, SearchResponse, Category, CategoryWithMarketData } from "./Interface";
/**
...
export declare class CoinGeckoClient {
  ...
  valid values: true, false
     ...
     */
    coinCategoriesList(): Promise<Category[]>;
    /**
