...
describe("CoinGeckoClient test", () => {
    ...
    describe("Category", () => {
        it("/coins/categories/list should successful", () => __awaiter(void 0, void 0, void 0, function* () {
            const list = yield client.coinCategoriesList();
            expect(list).toContainEqual({
                category_id: expect.any(String),
                name: expect.any(String),
            });
        }));
        it("/coins/categories should successful", () => __awaiter(void 0, void 0, void 0, function* () {
            const list = yield client.coinCategoriesListWithMarketData();
            expect(list).toContainEqual({
                id: expect.any(String),
                name: expect.any(String),
